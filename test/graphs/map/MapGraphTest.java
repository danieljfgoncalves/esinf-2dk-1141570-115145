...
/**
 * Tests the algorithms to manipulate a map graph.
 *
...
public class MapGraphTest {
    ...
    MapGraph<String, String> instance = new MapGraph<>(true);
    ...
    public void testClone() {
        ...
        MapGraph<String, String> instClone = instance.clone();
    ...
    public void testEquals() {
        ...
        MapGraph<String, String> other = instance.clone();
