...
public class MatrixGraphTest {
    ...
    public void testNumVertices() {
        ...
        MatrixGraph<String, Integer> instance = new MatrixGraph<>();
    ...
    public void testClone() throws CloneNotSupportedException {
        ...
        MatrixGraph<String, String> instance2 = (MatrixGraph<String, String>) instance.clone();
    ...
    public void testEqualsObject() throws CloneNotSupportedException {
        ...
        MatrixGraph<String, String> instance2 = instance;
        ...
        MatrixGraph<String, String> instance3 = new MatrixGraph<>();
